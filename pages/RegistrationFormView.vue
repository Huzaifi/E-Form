                    ...
                    <v-card class="transparent elevation-0">
                      <v-card-text>
                        ...
                        <v-checkbox
                          ...
                          label="Apakah anda yakin untuk memproses pembuatan tabungan baru?"
                          required
                        ></v-checkbox>
              ...
              >
                ...
                <v-card-text>
                  ...
                  <p class="black--text text-xs-justify">
                    Terima kasih karena telah melakukan pengajuan pembukaan tabungan di bank 
                    <strong>bjb</strong>. 
  ...
  methods: {
    ...
    validateForm1(e) {
      ...
      if (this.$refs.form1.validate()) {
        ...
        this.$http
          .get(
            "http://103.217.173.123:5020/api/v1/inq_ektp?nik=" +
              this.item.nik +
              "&account_type=" +
    ...
    validateForm3() {
      if (this.$refs.form3.validate()) {
        this.loadingDialog = true;
        this.item.type = this.$route.params.id;
        this.item.ticket_number = this.$route.params.ticketNumber;
