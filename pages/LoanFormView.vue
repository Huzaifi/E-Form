            ...
            <v-stepper-items>
              ...
              <v-stepper-content step="1">
                <v-container>
                  ...
                  >
                    <!-- <h1>{{ parameter.group_name }}</h1> -->
                    <!-- <ul v-for="item in bulkItems['tujuanPenggunaan']">
                      <li 
                    ...
                    <v-card class="transparent elevation-0">
                      <v-card-text>
                        <v-text-field
                          ...
                          label="No. E-KTP"
                          required
                          hint="Silahkan Masukan No. EKTP yang terdaftar."
                          persistent-hint
                        ></v-text-field>
                      </v-card-text>
                      <v-card-actions>
                ...
                <v-container>
                  <v-card class="transparent elevation-0">
                    <v-card-text>
                      ...
                      <v-layout wrap>
                        <v-flex md4 xs12>
                          <v-input :messages="ektp.nama_lgkp">
                            Nama Lengkap
                          </v-input>
                        </v-flex>
                        <v-flex md4 xs12>
                          <v-input :messages="ektp.tmpt_lhr + ', ' + ektp.tgl_lhr">
                            Tempat/Tanggal Lahir
                          </v-input>
                        </v-flex>
                        <v-flex md4 xs12>
                          <v-input :messages="ektp.jenis_klmin">
                            Jenis Kelamin
                          </v-input>
                        </v-flex>
                      </v-layout>
                      ...
                      <v-layout wrap>
                        <v-flex md3 xs12>
                          <v-input :messages=" '00' + ektp.no_rt + '/00' + ektp.no_rw">
                            RT / RW
                          </v-input>
                        </v-flex>
                        <v-flex md3 xs12>
                          <v-input :messages="ektp.kel_name">
                            Kelurahan / Desa
                          </v-input>
                        </v-flex>
                        <v-flex md3 xs12>
                          <v-input :messages="ektp.kec_name">
                            Kecamatan
                          </v-input>
                        </v-flex>
                      </v-layout>
                      ...
                      <v-layout wrap mb-4>
                        <v-flex md3 xs12>
                          <v-input :messages="ektp.status_kawin">
                            Status Perkawinan
                          </v-input>
                        </v-flex>
                        <v-flex md3 xs12>
                          <v-input :messages="ektp.jenis_pkrjn">
                            Pekerjaan
                          </v-input>
                        </v-flex>
                        <v-flex md3 xs12>
                          <v-input :messages="ektp.agama">
                            Agama
                          </v-input>
                        </v-flex>
                        <v-flex md3 xs12>
                          <v-input :messages="ektp.pddk_akh">
                            Pendidikan Akhir
                          </v-input>
                        </v-flex>
                      </v-layout>
              ...
              >
                ...
                <v-card-text>
                  ...
                  <p class="black--text text-xs-justify">
                    Terima kasih karena telah melakukan pengajuan pinjaman di bank <strong>bjb</strong>. 
                    Silahkan bawa bukti pengajuan ini ke cabang bank bjb terdekat, 
                    paling lambat 3X24 jam kerja, atau data pengajuan akan terhapus secara otomatis.
                  </p>
                  <p class="black--text text-xs-justify">
                    Jika terjadi kesalahan data yang telah diinputkan, 
                    Bapak/ Ibu dapat melakukan perubahan data melalui form pengajuan perubahan data. 
                    Klik link dibawah ini jika ingin melakukan perubahan data.; 
                  </p>

                  <v-layout column wrap justify-center align-center>
                    <v-flex>
                      <v-btn 
                        to="formPerubahanDataLoan"
                        color="primary"
                      >
                        Form Perubahan Data
                      </v-btn>
                    ...
                    <v-flex mt-2>
                      <qrcode-vue :value="responseSuccess.no_loan ? responseSuccess.no_loan.toString() : '' " :size="130" level="H"></qrcode-vue>
                    </v-flex>
                    <p class="info--text text-xs-center">
                      *Anda bisa menyimpan Nomor Referensi dalam bentuk QRcode. Silahkan scan menggunakan aplikasi yang ada di hp anda.
                    </p>
                  </v-layout>

                  <br>
                  <span class="black--text font-weight-bold">Tanggal Pengajuan: {{ responseSuccess.created_at }} </span>
                  <br>
  ...
  methods: {
    validateForm1(e) {
      ...
      if (this.$refs.form1.validate()) {
        ...
        api
          .inqNik(this.ektp.nik, this.$route.params.id)
          .then(response => {
            // console.log(response);
            // success
            this.ektp = response.data;
            this.ektp.email = "";
            this.ektp.handphone = "";
            this.formStep = 2;
    ...
    validateForm6() {
      if (this.$refs.form6.validate()) {
        ...
        this.$http
          .post("http://103.217.173.123:5020/api/v1/loans", this.dataLoan, {
            headers: {
              Authorization:
